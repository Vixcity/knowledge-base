...
需要访问`TelephoneNumber`对象时，只须把`Person`类中那些`office`开头的访问函数搬移过来并略作修改即可。
...
![替换算法](http://localhost:8000/af88f612-4683-4b91-a27b-c216da958f43/OEBPS/Images/image00321.jpeg)
